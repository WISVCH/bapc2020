...
export default function template(this: BapcView) {
  return html`
    ...
    <h1>News</h1>
      ...
      <p>The BAPC 2020 is won by team while (false) break; from Utrecht University. You can view the final <a href="https://2020.bapc.eu/scoreboard">scoreboard</a> of the contest. Probelms and solutions are available <a href="https://2020.bapc.eu/problems" target="_blank">here</a>. Thanks to everyone for a great contest.<br/><small>posted: 12th of December by the BAPC Organisation</small></p>
      <hr>
